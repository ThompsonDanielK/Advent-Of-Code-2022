            ...
            for (int i = 0; i < puzzleInput.Count; i++)
            {
                ...
                if (quantityToMove != "" && !readingInventoryMap)
                {
                    ...
                    for (int q = 0; q < parsedQuantityToMove; q++)
                    {
                        ...
                        columnNumberToList[parsedDestinationColumn].Add(columnNumberToList[parsedDepartingColumn][columnNumberToList[parsedDepartingColumn].Count() - 1]);
                        columnNumberToList[parsedDepartingColumn].RemoveAt(columnNumberToList[parsedDepartingColumn].Count() - 1);
                    }
                }
            }
